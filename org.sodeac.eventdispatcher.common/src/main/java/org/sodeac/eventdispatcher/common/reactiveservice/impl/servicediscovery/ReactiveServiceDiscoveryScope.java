...
(
	...
	property=
	{
		EventDispatcherConstants.PROPERTY_QUEUE_MATCH_FILTER+"="+"(org.sodeac.eventdispatcher.common.reactiveservice.impl.servicediscovery.ReactiveServiceDiscoveryScope=true)"
	}
)
