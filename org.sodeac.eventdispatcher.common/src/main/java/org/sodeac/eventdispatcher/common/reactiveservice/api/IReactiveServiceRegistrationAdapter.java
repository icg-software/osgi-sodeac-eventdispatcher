...
{
	public static final String SERVICE_PROPERTY__MATCH_QUEUE = IEventDispatcher.PROPERTY_QUEUE_MATCH_FILTER+"="+"(org.sodeac.eventdispatcher.common.reactiveservice.api.IReactiveServiceRegistrationAdapter=*)";
