...
public class DirectoryWatcherController implements IEventController, IOnEventScheduled, IOnJobError, IOnQueueObserve, IOnQueueReverse,IDescriptionProvider,IStateInfoProvider
{
