...
public abstract class AbstractTest
{
	...
	public Option[] config() 
	{
		...
		return new Option[] 
		{
			...
			reactorBundle("org.sodeac.eventdispatcher.provider","0.9.11").start(),
			reactorBundle("org.sodeac.eventdispatcher.extension.jmx","0.9.11").start(),
			reactorBundle("org.sodeac.eventdispatcher.common","0.9.11").start(),
