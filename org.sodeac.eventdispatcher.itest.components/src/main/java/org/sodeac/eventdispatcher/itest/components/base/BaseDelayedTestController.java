...
(
	...
	property=
	{
		EventDispatcherConstants.PROPERTY_QUEUE_ID+"="+BaseDelayedTestController.QUEUE_ID,
		EventConstants.EVENT_TOPIC+"=" + BaseDelayedTestController.SCHEDULE_EVENT
	}
)
public class BaseDelayedTestController extends AbstractBaseTestController implements EventHandler,IQueueController,IOnQueuedEvent,IOnRemovedEvent,IOnTaskDone,IOnTaskError,IOnTaskTimeout,IOnFiredEvent,IOnQueueAttach,IOnQueueDetach,IOnQueueSignal
{
