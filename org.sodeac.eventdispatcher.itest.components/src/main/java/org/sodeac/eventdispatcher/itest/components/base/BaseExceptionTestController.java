...
(
	...
	property=
	{
		EventDispatcherConstants.PROPERTY_QUEUE_ID+"="+BaseExceptionTestController.QUEUE_ID,
		EventConstants.EVENT_TOPIC+"=" + BaseExceptionTestController.SCHEDULE_EVENT
	}
)
public class BaseExceptionTestController extends AbstractBaseTestController implements EventHandler,IQueueController,IOnQueuedEvent,IOnRemovedEvent,IOnTaskDone,IOnTaskError,IOnTaskTimeout,IOnFiredEvent,IOnQueueAttach,IOnQueueDetach,IOnQueueSignal
{
