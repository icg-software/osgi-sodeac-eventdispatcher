...
(
	...
	property=
	{
		EventDispatcherConstants.PROPERTY_QUEUE_ID+"="+ RescheduleJobByOnEventScheduledTestService.QUEUE_ID,
		EventDispatcherConstants.PROPERTY_PERIODIC_REPETITION_INTERVAL+"=5000",
		EventDispatcherConstants.PROPERTY_SERVICE_ID+"=" + RescheduleJobByOnEventScheduledTestService.SERVICE_ID,
