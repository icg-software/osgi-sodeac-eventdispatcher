...
(
	...
	property=
	{
		...
		IQueueService.PROPERTY_SERVICE_ID+"=" + ReReScheduleJobInWorkTestService4.SERVICE_ID,
...
public class ReReScheduleJobInWorkTestService4 implements EventHandler,IEventController,IOnEventScheduled,IQueueService
{
	...
	public void run(IQueue queue, IMetrics metrics, IPropertyBlock propertyBlock, IJobControl jobControl, List<IQueueJob> currentProcessedJobList)
	{
		...
		{
			queue.rescheduleJob(SERVICE_ID, System.currentTimeMillis() - 13, -1, -1);
