...
(
	...
	property=
	{
		EventDispatcherConstants.PROPERTY_QUEUE_ID+"="+ ReReScheduleJobInWorkTestService4.QUEUE_ID,
		EventDispatcherConstants.PROPERTY_PERIODIC_REPETITION_INTERVAL+"=5000",
		EventDispatcherConstants.PROPERTY_SERVICE_ID+"=" + ReReScheduleJobInWorkTestService4.SERVICE_ID,
		EventConstants.EVENT_TOPIC+"=" + ReReScheduleJobInWorkTestService4.SHARED_OBJECT_EVENT,
		EventConstants.EVENT_TOPIC+"=" + ReReScheduleJobInWorkTestService4.DATA_VALUE_EVENT
	}
)
public class ReReScheduleJobInWorkTestService4 implements EventHandler,IQueueController,IOnQueuedEvent,IQueueService
{
	...
	public static final String SHARED_OBJECT_EVENT = "org/sodeac/eventdispatcher/itest/reschedulejobbyoneventscheduledservice4/sharedobject";
	public static final String DATA_VALUE_EVENT = "org/sodeac/eventdispatcher/itest/reschedulejobbyoneventscheduledservice4/datavalue";
