...
public class BaseTimeoutAndStop1TestController extends AbstractBaseTestController implements EventHandler,IEventController,IOnScheduleEvent,IOnRemoveEvent,IOnJobDone,IOnJobError,IOnJobTimeout,IOnFireEvent,IOnQueueObserve,IOnQueueReverse,IOnQueueSignal
{
	...
	{
		dispatcher.schedule(BaseTimeoutAndStop1TestController.QUEUE_ID, event);
	}
