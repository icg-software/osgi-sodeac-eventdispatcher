...
(
	...
	property=
	{
		EventDispatcherConstants.PROPERTY_QUEUE_ID+"="+ ReReScheduleJobInWorkTestService5.QUEUE_ID,
		EventDispatcherConstants.PROPERTY_PERIODIC_REPETITION_INTERVAL+"=5000",
		EventDispatcherConstants.PROPERTY_SERVICE_ID+"=" + ReReScheduleJobInWorkTestService5.SERVICE_ID,
