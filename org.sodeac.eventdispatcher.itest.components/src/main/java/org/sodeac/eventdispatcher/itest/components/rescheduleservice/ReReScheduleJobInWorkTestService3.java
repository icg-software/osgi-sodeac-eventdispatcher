...
(
	...
	property=
	{
		EventDispatcherConstants.PROPERTY_QUEUE_ID+"="+ ReReScheduleJobInWorkTestService3.QUEUE_ID,
		EventDispatcherConstants.PROPERTY_PERIODIC_REPETITION_INTERVAL+"=5000",
		EventDispatcherConstants.PROPERTY_SERVICE_ID+"=" + ReReScheduleJobInWorkTestService3.SERVICE_ID,
		EventConstants.EVENT_TOPIC+"=" + ReReScheduleJobInWorkTestService3.SHARED_OBJECT_EVENT,
		EventConstants.EVENT_TOPIC+"=" + ReReScheduleJobInWorkTestService3.DATA_VALUE_EVENT
	}
)
public class ReReScheduleJobInWorkTestService3 implements EventHandler,IQueueController,IOnQueuedEvent,IQueueService
{
	public static final String QUEUE_ID = "reschedulejobbyoneventscheduledtestservicequeue3";
	public static final String SERVICE_ID = "reschedulejobbyoneventscheduledtestservice3";
	public static final String SHARED_OBJECT_EVENT = "org/sodeac/eventdispatcher/itest/reschedulejobbyoneventscheduledservice3/sharedobject";
	public static final String DATA_VALUE_EVENT = "org/sodeac/eventdispatcher/itest/reschedulejobbyoneventscheduledservice3/datavalue";
	...
	public void run(IQueue queue, IMetrics metrics, IPropertyBlock propertyBlock, ITaskControl taskControl, List<IQueueTask> currentProcessedJobList)
	{
		...
		{
			queue.rescheduleTask(SERVICE_ID, System.currentTimeMillis(), -1, -1);
