...
(
	...
	property=
	{
		IEventDispatcher.PROPERTY_QUEUE_ID+"="+ ReReScheduleJobInWorkTestService3.QUEUE_ID,
		IQueueService.PROPERTY_PERIODIC_REPETITION_INTERVAL+"=5000",
		IQueueService.PROPERTY_SERVICE_ID+"=" + ReReScheduleJobInWorkTestService3.SERVICE_ID,
...
public class ReReScheduleJobInWorkTestService3 implements EventHandler,IEventController,IOnEventScheduled,IQueueService
{
	...
	public void run(IQueue queue, IMetrics metrics, IPropertyBlock propertyBlock, IJobControl jobControl, List<IQueueJob> currentProcessedJobList)
	{
		...
		{
			queue.rescheduleJob(SERVICE_ID, System.currentTimeMillis(), -1, -1);
