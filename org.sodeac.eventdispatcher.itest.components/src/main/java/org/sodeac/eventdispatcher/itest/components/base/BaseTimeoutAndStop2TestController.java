...
(
	...
	property=
	{
		EventDispatcherConstants.PROPERTY_QUEUE_ID+"="+BaseTimeoutAndStop2TestController.QUEUE_ID,
		EventConstants.EVENT_TOPIC+"=" + BaseTimeoutAndStop2TestController.SCHEDULE_EVENT
	}
)
public class BaseTimeoutAndStop2TestController extends AbstractBaseTestController implements EventHandler,IQueueController,IOnQueuedEvent,IOnRemovedEvent,IOnTaskDone,IOnTaskError,IOnTaskTimeout,IOnFiredEvent,IOnQueueAttach,IOnQueueDetach,IOnQueueSignal
{
